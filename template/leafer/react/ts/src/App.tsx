...
import { App as LeaferApp, Rect, Text, Group, PointerEvent } from 'leafer-ui'
...
export default function App() {
  useEffect(() => {
    const leafer = new LeaferApp({ view: 'leafer-view', fill: '#242424', editor: {} })
    ...
    return () => {
      // 开发环境useEffect会执行2次，必须及时销毁
      // useEffect hooks will run twice when using React.StrictMode in development mode,so it must be destroyed promptly.
      leafer.destroy() 
    }
  })
