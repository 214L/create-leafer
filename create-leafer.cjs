      ...
      return Object.defineProperty(function(...args) {
        if (typeof args[args.length - 1] === "function")
          ...
          return new Promise((resolve7, reject) => {
            args.push((err, res) => err != null ? reject(err) : resolve7(res));
            fn.apply(this, args);
          });
        }
      }, "name", { value: fn.name });
  ...
  "node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/polyfills.js"(exports, module2) {
    ...
    function patch(fs7) {
      ...
      if (fs7.chmod && !fs7.lchmod) {
        fs7.lchmod = function(path6, mode, cb) {
          if (cb)
            process.nextTick(cb);
        };
      ...
      if (fs7.chown && !fs7.lchown) {
        fs7.lchown = function(path6, uid, gid, cb) {
          if (cb)
            process.nextTick(cb);
        };
      ...
      function patchLchmod(fs8) {
        ...
        fs8.lchmodSync = function(path6, mode) {
          var fd = fs8.openSync(path6, constants.O_WRONLY | constants.O_SYMLINK, mode);
          var threw = true;
          var ret;
          try {
      ...
      function patchLutimes(fs8) {
        if (constants.hasOwnProperty("O_SYMLINK") && fs8.futimes) {
          fs8.lutimes = function(path6, at, mt, cb) {
          ...
          fs8.lutimesSync = function(path6, at, mt) {
            var fd = fs8.openSync(path6, constants.O_SYMLINK);
            var ret;
            var threw = true;
            try {
...
var require_legacy_streams = __commonJS({
  "node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/legacy-streams.js"(exports, module2) {
    ...
    function legacy(fs7) {
      ...
      function ReadStream(path6, options2) {
        if (!(this instanceof ReadStream))
          return new ReadStream(path6, options2);
        Stream.call(this);
        var self2 = this;
        this.path = path6;
        this.fd = null;
      ...
      function WriteStream(path6, options2) {
        if (!(this instanceof WriteStream))
          return new WriteStream(path6, options2);
        Stream.call(this);
        this.path = path6;
        this.fd = null;
        this.writable = true;
...
var require_graceful_fs = __commonJS({
  "node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/graceful-fs.js"(exports, module2) {
    ...
    function patch(fs8) {
      ...
      function readFile(path6, options2, cb) {
        if (typeof options2 === "function")
          cb = options2, options2 = null;
        return go$readFile(path6, options2, cb);
        function go$readFile(path7, options3, cb2, startTime) {
          return fs$readFile(path7, options3, function(err) {
            if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
              enqueue([go$readFile, [path7, options3, cb2], err, startTime || Date.now(), Date.now()]);
            else {
      ...
      function writeFile(path6, data, options2, cb) {
        if (typeof options2 === "function")
          cb = options2, options2 = null;
        return go$writeFile(path6, data, options2, cb);
        function go$writeFile(path7, data2, options3, cb2, startTime) {
          return fs$writeFile(path7, data2, options3, function(err) {
            if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
              enqueue([go$writeFile, [path7, data2, options3, cb2], err, startTime || Date.now(), Date.now()]);
            else {
              if (typeof cb2 === "function")
                cb2.apply(this, arguments);
            }
      ...
      function appendFile(path6, data, options2, cb) {
        if (typeof options2 === "function")
          cb = options2, options2 = null;
        return go$appendFile(path6, data, options2, cb);
        function go$appendFile(path7, data2, options3, cb2, startTime) {
          return fs$appendFile(path7, data2, options3, function(err) {
            if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
              enqueue([go$appendFile, [path7, data2, options3, cb2], err, startTime || Date.now(), Date.now()]);
            else {
              if (typeof cb2 === "function")
                cb2.apply(this, arguments);
            }
      ...
      function readdir(path6, options2, cb) {
        if (typeof options2 === "function")
          cb = options2, options2 = null;
        var go$readdir = noReaddirOptionVersions.test(process.version) ? function go$readdir2(path7, options3, cb2, startTime) {
          ...
          return fs$readdir(path7, options3, fs$readdirCallback(
            path7,
            options3,
            cb2,
            startTime
        ...
        function fs$readdirCallback(path7, options3, cb2, startTime) {
      ...
      function createReadStream(path6, options2) {
        return new fs8.ReadStream(path6, options2);
      }
      function createWriteStream(path6, options2) {
        return new fs8.WriteStream(path6, options2);
      }
...
var require_path_exists = __commonJS({
  "node_modules/.pnpm/fs-extra@11.2.0/node_modules/fs-extra/lib/path-exists/index.js"(exports, module2) {
    ...
    function pathExists(path6) {
      return fs7.access(path6).then(() => true).catch(() => false);
    }
    module2.exports = {
...
var require_utimes = __commonJS({
  "node_modules/.pnpm/fs-extra@11.2.0/node_modules/fs-extra/lib/util/utimes.js"(exports, module2) {
    ...
    async function utimesMillis(path6, atime, mtime) {
      const fd = await fs7.open(path6, "r+");
      let closeErr = null;
      try {
...
var require_remove = __commonJS({
  "node_modules/.pnpm/fs-extra@11.2.0/node_modules/fs-extra/lib/remove/index.js"(exports, module2) {
    ...
    function remove(path6, callback) {
      fs7.rm(path6, { recursive: true, force: true }, callback);
    }
    function removeSync(path6) {
      fs7.rmSync(path6, { recursive: true, force: true });
    }
    module2.exports = {
      remove: u(remove),
      removeSync
...
var require_jsonfile = __commonJS({
  "node_modules/.pnpm/jsonfile@6.1.0/node_modules/jsonfile/index.js"(exports, module2) {
    ...
    function readFileSync4(file, options2 = {}) {
      if (typeof options2 === "string") {
        options2 = { encoding: options2 };
      }
      const fs7 = options2.fs || _fs;
...
-  already used by option '${matchingOption.flags}'`);
      ...
      _prepareUserArgs(argv, parseOptions) {
        ...
        if (argv === void 0 && parseOptions.from === void 0) {
          if ((_a = process11.versions) == null ? void 0 : _a.electron) {
...
var require_figures = __commonJS({
  "node_modules/.pnpm/prompts@2.4.2/node_modules/prompts/lib/util/figures.js"(exports, module2) {
    ...
    var win = {
      arrowUp: main3.arrowUp,
      arrowDown: main3.arrowDown,
      arrowLeft: main3.arrowLeft,
      arrowRight: main3.arrowRight,
      radioOn: "(*)",
      radioOff: "( )",
      tick: "\u221A",
      cross: "\xD7",
    ...
    var figures = process.platform === "win32" ? win : main3;
...
var require_emoji_regex = __commonJS({
  "node_modules/.pnpm/emoji-regex@10.3.0/node_modules/emoji-regex/index.js"(exports, module2) {
    module2.exports = () => {
...
// src/commands/vueTemplate.ts
var fs4 = __toESM(require("fs"), 1);
var path4 = __toESM(require("path"), 1);
var import_node_process8 = __toESM(require("process"), 1);
var import_prompts = __toESM(require_lib2(), 1);
...
function kolorist(start, end, level = 1) {
  ...
  const regex2 = new RegExp(`\\x1b\\[${end}m`, "g");
  return (str) => {
    return options.enabled && options.supportLevel >= level ? open + ("" + str).replace(regex2, open) + close : "" + str;
  };
}
...
var StdinDiscarder = class {
  constructor() {
    __privateAdd(this, _realStart);
    __privateAdd(this, _realStop);
  ...
  start() {
    ...
    if (__privateGet(this, _activeCount) === 1) {
      __privateMethod(this, _realStart, realStart_fn).call(this);
    }
  }
  stop() {
    ...
    __privateWrapper(this, _activeCount)._--;
    if (__privateGet(this, _activeCount) === 0) {
      __privateMethod(this, _realStop, realStop_fn).call(this);
    }
  }
};
_activeCount = new WeakMap();
_realStart = new WeakSet();
realStart_fn = function() {
  ...
  import_node_process6.default.stdin.on("data", __privateMethod(this, _handleInput, handleInput_fn));
...
realStop_fn = function() {
  ...
  import_node_process6.default.stdin.off("data", __privateMethod(this, _handleInput, handleInput_fn));
...
`);
  ...
  succeed(text2) {
    return this.stopAndPersist({ symbol: log_symbols_default.success, text: text2 });
  }
  fail(text2) {
    return this.stopAndPersist({ symbol: log_symbols_default.error, text: text2 });
  }
  warn(text2) {
    return this.stopAndPersist({ symbol: log_symbols_default.warning, text: text2 });
  }
  info(text2) {
    return this.stopAndPersist({ symbol: log_symbols_default.info, text: text2 });
  }
  stopAndPersist(options2 = {}) {
    ...
    const text2 = options2.text ?? this.text;
    const fullText = typeof text2 === "string" ? " " + text2 : "";
    const suffixText = options2.suffixText ?? __privateGet(this, _suffixText);
...
var defaultZhEnding = "\u50CF\u5C0F\u6811\u53D1\u82BD\u4E00\u6837\u4E0D\u65AD\u6210\u957F\uFF0C\u5145\u6EE1\u5E0C\u671B\u548C\u751F\u547D\u529B";
function getBanners(language) {
  const isColorSupported = process.stdout.isTTY && process.stdout.getColorDepth() > 8;
  const banners = {
    en: {
      startingBanner: isColorSupported ? gradientEnStarting : defaultEnStarting,
      endingBanner: isColorSupported ? gradientEnEndingBanner : defaultEnEnding
    },
    zh: {
      startingBanner: isColorSupported ? gradientZhStarting : defaultZhStarting,
      endingBanner: isColorSupported ? gradientZhEnding : defaultZhEnding
    }
  };
  return banners[language === "zh" ? "zh" : "en"];
}

// utils/generateGradientBanner.ts
...
function generateAnsiGradientText(text2, startColor2, endColor2) {
  const steps = text2.length;
  const startRgb = startColor2.match(/\d+/g).map(Number);
  const endRgb = endColor2.match(/\d+/g).map(Number);
  const gradientColors = rgbGradient(startRgb, endRgb, steps);
  let ansiText = "";
  for (let i = 0; i < text2.length; i++) {
    const [r, g, b] = gradientColors[i];
    ansiText += `\x1B[38;2;${r};${g};${b}m${text2[i]}\x1B[39m`;
  }
  return ansiText;
}
...
async function getLeaferVersion() {
...
function getPrompt() {
  ...
  const prompt = doesLanguageExist ? require(languageFilePath) : require(path.resolve(promptRoot, "en-US.json"));
  return prompt;
}
function getUser() {
  let userName = getGitUsername() ? getGitUsername() : getNpmUsername() ? getNpmUsername() : "";
  let emailAddress = getGitEmailAddress() ? ` <${getGitEmailAddress()}>` : "";
  return userName + emailAddress;
}
function getNpmUsername() {
  try {
    return (0, import_node_child_process.execSync)("npm whoami", { encoding: "utf8" }).trim();
  } catch (err) {
    return null;
  }
}
function getGitUsername() {
  try {
    return (0, import_node_child_process.execSync)("git config --get user.name", { encoding: "utf8" }).trim();
  } catch (err) {
    return null;
  }
}
function getGitEmailAddress() {
  try {
    return (0, import_node_child_process.execSync)("git config --get user.email", { encoding: "utf8" }).trim();
  } catch (err) {
    return null;
  }
}
...
function canSkipOverwriteOption(dir) {
...
function emptyDirectory(dir) {
  ...
  traverseAndClean(
    dir,
    (dirPath) => fs2.rmdirSync(dirPath),
    (filePath) => fs2.unlinkSync(filePath)
  );
}
function traverseAndClean(dir, onDir, onFile) {
  for (const itemName of fs2.readdirSync(dir)) {
    if (itemName === ".git") {
      continue;
    }
    const fullPath = path2.resolve(dir, itemName);
...
function toValidPackageName(projectName) {
  let inputName = projectName.trim().toLowerCase().replace(/\s+/g, "-").replace(/^[._]/, "").replace(/[^a-z0-9-~]+/g, "-");
  const regex2 = /^(leafer-x|@[a-zA-Z0-9_-]+\/leafer-x)/;
  if (regex2.test(inputName)) {
    return inputName;
  } else {
    return "leafer-x-";
  }
}
function getGlobalName(str) {
  if (str.startsWith("@")) {
    str = str.replace(/^@[^/]+\//, "");
  }
  ...
  return "LeaferX." + parts.map((part, index) => {
...
function renderTemplate(src, dest) {
  ...
  if (stats.isDirectory()) {
    ...
    for (const file of fs3.readdirSync(src)) {
      renderTemplate(path3.resolve(src, file), path3.resolve(dest, file));
    }
    return;
  }
  const filename = path3.basename(src);
  if (filename === "package.json" && fs3.existsSync(dest)) {
    const existing = JSON.parse(fs3.readFileSync(dest, "utf8"));
    const newPackage = JSON.parse(fs3.readFileSync(src, "utf8"));
    const pkg = deepMerge(existing, newPackage);
    fs3.writeFileSync(dest, JSON.stringify(pkg, null, 2) + "\n");
    return;
  }
  if (filename.startsWith("_")) {
    dest = path3.resolve(path3.dirname(dest), filename.replace(/^_/, "."));
  }
  if (filename === "_gitignore" && fs3.existsSync(dest)) {
    const existing = fs3.readFileSync(dest, "utf8");
    const newGitignore = fs3.readFileSync(src, "utf8");
    fs3.writeFileSync(dest, existing + "\n" + newGitignore);
    return;
  }
...
// src/commands/vueTemplate.ts
var vueTemplate = new Command().name("vue-template").description("generate a leafer+vue template project powered by vite").option(
  "-c, --cwd <cwd>",
  "the working directory. defaults to the current directory.",
  import_node_process8.default.cwd()
).action(async (opts) => {
      ...
      [
        {
          ...
          onState: (state) => targetDir = String(state.value).trim() || "leafer-project"
        },
        {
          name: "shouldOverwrite",
          type: () => canSkipOverwriteOption(targetDir) ? null : "toggle",
          message: () => {
            const dirForPrompt = targetDir === "." ? promptMessage.shouldOverwrite.dirForPrompts.current : `${promptMessage.shouldOverwrite.dirForPrompts.target} "${targetDir}"`;
...
${gray(
  ...
  fs4.writeFileSync(
    path4.resolve(root, "package.json"),
  ...
  render("leafer/vue");
  let packagePath = path4.resolve(root, "package.json");
  if (fs4.existsSync(packagePath)) {
    const existing = JSON.parse(fs4.readFileSync(packagePath, "utf8"));
    ...
    fs4.writeFileSync(packagePath, JSON.stringify(existing, null, 2));
  }
  console.log(`
...
var import_prompts2 = __toESM(require_lib2(), 1);
var plugin = new Command().name("plugin").description("Create a LeaferX project").action(async (opts) => {
  const promptMessage = getPrompt();
  let leaferVersion = await getLeaferVersion();
  let banners = getBanners(promptMessage.language);
  console.log();
  ...
  let result = {};
  try {
    result = await (0, import_prompts2.default)(
      [
        {
          name: "projectName",
          type: "text",
...
${gray(
          ...
          initial: () => toValidPackageName(targetDir),
          validate: (dir) => isValidPackageName(dir) || promptMessage.pluginPackageName.invalidMessage
        },
        {
  ...
  render("leaferx/base");
  let rollupConfigPath = path5.resolve(root, "rollup.config.js");
  if (fs5.existsSync(rollupConfigPath)) {
    const existing = fs5.readFileSync(rollupConfigPath, "utf8");
    let modifiedData = existing.replace(
    ...
    fs5.writeFileSync(rollupConfigPath, modifiedData);
  }
  let packagePath = path5.resolve(root, "package.json");
  if (fs5.existsSync(packagePath)) {
    const existing = JSON.parse(fs5.readFileSync(packagePath, "utf8"));
    existing.dependencies["@leafer-ui/core"] = `^${leaferVersion}`;
    existing.devDependencies["leafer-ui"] = `^${leaferVersion}`;
    existing.name = pkg.name;
    existing.author = pkg.author;
    fs5.writeFileSync(packagePath, JSON.stringify(existing, null, 2));
  }
  console.log(`
${promptMessage.infos.done}
`);
...
async function main2() {
  ...
  function checkForUpdates() {
    try {
      ...
      const [currentMajor, currentMinor] = packageInfo.version.split(".").map(Number);
  ...
  program2.addCommand(vueTemplate);
  program2.addCommand(plugin);
  program2.parse();
}
main2();
